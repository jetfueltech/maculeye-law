...
const SYSTEM_TEMPLATES: Omit<FormTemplateInsert, 'firm_id'>[] = [
  ...
  { name: 'SAP Intake Form', form_key: 'sap_intake_form', category: 'Intake & Representation', description: 'Auto-populated intake spreadsheet with all case data.', naming_pattern: '{LastName}_{FirstName}_{DOL}_SAPIntake_v{Version}', is_active: true, is_system: true, icon: 'M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', sort_order: 2 },
