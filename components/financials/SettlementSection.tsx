  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-100">
        <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Settlement</h3>
      </div>
      <div className="p-6">
        {editing ? (
          ...
          <div className="space-y-2">
            ...
            <div className="border-t-2 border-slate-200 pt-3 mt-3 flex justify-between items-center">
              <span className="text-sm font-bold text-slate-800 uppercase">Gross Settlement</span>
              <span className="text-base font-bold text-slate-900 tabular-nums">{currency(grossSettlement)}</span>
            </div>
          </div>
        )}
      </div>
