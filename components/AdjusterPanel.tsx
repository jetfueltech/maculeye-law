            ...
            <div key={adj.id} className="px-3 py-2.5 rounded-lg hover:bg-slate-50 group transition-colors border border-transparent hover:border-slate-100">
              <div className="flex items-center justify-between gap-2 mb-1">
                <div className="flex items-center gap-2 min-w-0">
                  <span className="text-base font-bold text-slate-900 truncate">{adj.name}</span>
                  {adj.isPrimary && (
              ...
              <div className="flex items-center gap-4 mt-1">
                {adj.phone && (
                  <a href={`tel:${adj.phone}`} className="flex items-center gap-1.5 text-xs text-slate-500 hover:text-blue-600 hover:underline transition-colors whitespace-nowrap">
                ...
                {adj.email && (
                  <a href={`mailto:${adj.email}`} className="flex items-center gap-1.5 text-xs text-slate-500 hover:text-blue-600 hover:underline truncate transition-colors">
