          ...
          {adjusters.map(adj => (
            <div key={adj.id} className="px-3 py-2.5 rounded-lg hover:bg-slate-50 group transition-colors border border-transparent hover:border-slate-100">
              ...
              <div className="flex items-center gap-4 mt-1">
                {adj.phone && (
                  <a href={`tel:${adj.phone}`} className="flex items-center gap-1.5 text-xs font-medium text-blue-600 hover:text-blue-800 hover:underline transition-colors whitespace-nowrap">
                ...
                {adj.email && (
                  <a href={`mailto:${adj.email}`} className="flex items-center gap-1.5 text-xs font-medium text-blue-600 hover:text-blue-800 hover:underline truncate transition-colors">
